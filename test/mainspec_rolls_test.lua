...
function MainspecRollsSpec:should_not_reroll_if_enough_items_dropped_for_players_that_tied_and_top_roll_is_not_a_tie()
  -- Given
  player( "Psikutas" )
  is_in_raid( leader( "Psikutas" ), "Obszczymucha", "Ponpon" )
...
function MainspecRollsSpec:should_not_reroll_if_enough_items_dropped_for_players_that_tied_and_top_roll_is_a_tie()
  -- Given
  player( "Psikutas" )
  is_in_raid( leader( "Psikutas" ), "Obszczymucha", "Ponpon" )
