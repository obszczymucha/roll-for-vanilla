...
local function new_mod( finish_early, cancel_roll, raid_roll )
  local popup = mock_popup()
  local noop = function() end
  local mod = new( popup, controller, tracker, finish_early or noop, cancel_roll or noop, raid_roll or noop )
