...
function M.new( popup_builder, content_transformer, config, db )
  ...
  local function default_content()
    ...
    add_toggle( settings, "auto_round_robin_announce" )
    add_toggle( settings, "auto_round_robin_announce_drops" )
    ...
    add_slider( settings, "round_robin_queue_rows", "Round robin queue rows", 3, 20, 0 )
